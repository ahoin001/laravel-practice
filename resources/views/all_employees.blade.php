...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiase" >
        ...
        <div class="flex-center position-ref full-height">
            <div class="content">
               <ul>
                 ...
                 <li><a href="/" style="color:white">Back To Links</a></li>
               </ul>
            </div>
           </div>
        ...
        <div class="flex-center position-ref full-height">
            ...
            <h1 style="text-align: center; color:white">All Employees Returned From Database</h1>

            <div class="content" style="padding:60px; display:flex; flex-wrap:wrap">
                

               @foreach($employees as $key => $value)

               <div style="color:white; flex:1 1 300px; display:flex; flex-direction:column; padding:12px; background-color:#2d3849; max-width:600px; margin:10px">
