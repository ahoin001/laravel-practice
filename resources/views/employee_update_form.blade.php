                    ...
                    <div class="">
                        <div class="p-6">
                            ...
                            <div style="">
                                ...
                                {{-- action is the route we send the form too --}}
                                <form action="/employees/updateEmployee/{{$employee->employee_id}}" method="POST" 
                                  style="display: flex; flex-direction:column; justify-content:space-evenly; height:500px; width:500px
                                         padding:20px   ">
